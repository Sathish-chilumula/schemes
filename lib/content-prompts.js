...
2. Key Benefits (Exact money or facilities. Be very specific about amounts.)
3. Who Can Apply? (Eligibility Criteria checklist)
4. Documents Required (Clear list of papers needed)
5. How to Apply — Complete Step-by-Step Process (Simple steps anyone can follow)
6. Important Dates (Open dates or cycles)
7. Official Resources (Provide the verified URL or portal name)
8. Common Mistakes to Avoid (Pro tips to help user succeed)
`;
...
2. Key Benefits (Exact money or facilities)
3. Who Can Apply? (Eligibility Criteria checklist)
4. Selection / Approval Process (How the government picks people)
5. Documents Required (Clear list of papers needed)
6. How to Apply — Complete Step-by-Step Process (Simple steps anyone can follow)
7. Official Resources (Provide the verified URL or portal name)
`;
