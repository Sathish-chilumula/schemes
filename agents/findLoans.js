...
const CORE_NEWSDATA_QUERIES = [
  { q: 'government business loan msme subsidy india 2026', country: 'in', lang: 'en', countryCode: 'IN', stateCode: null },
  { q: 'education loan scheme government subsidy student india 2026', country: 'in', lang: 'en', countryCode: 'IN', stateCode: null },
  { q: 'home loan subsidy pmay awas yojana india', country: 'in', lang: 'en', countryCode: 'IN', stateCode: null },
  { q: 'mudra loan start up business women subsidy india', country: 'in', lang: 'en', countryCode: 'IN', stateCode: null },
  { q: 'agriculture crop loan kisan credit card subsidy india', country: 'in', lang: 'en', countryCode: 'IN', stateCode: null },
];

const GNEWS_QUERIES_IN = [
  { q: 'government loan subsidy business MSME india 2026', stateCode: null },
  { q: 'education loan student subsidy government india', stateCode: null },
  { q: 'home loan subsidy scheme awas yojana 2026', stateCode: null },
  { q: 'agriculture farmer crop loan waiver subsidy india', stateCode: null },
  { q: 'women self help group SHG microfinance loan india', stateCode: null },
];
...
const SCHEME_AUTOCOMPLETE_SEEDS = [
  'government business loan apply online 2026',
  'msme loan subsidy scheme new',
  'pm mudra loan apply 2026',
  'student education loan government subsidy india',
  'agriculture loan kisan credit card 2026',
  'home loan subsidy pmay 2026',
  'women business loan scheme india',
  'startup india loan scheme subsidy',
  'minority business loan scheme apply',
  'state government loan for unemployed youth',
];
...
const SCHEME_CONFIRM_WORDS = [
  'loan', 'subsidy', 'credit', 'finance', 'mudra', 'msme',
  'startup', 'mortgage', 'borrow', 'lending', 'interest',
  'repayment', 'microfinance', 'capital', 'fund'
];
...
If this is a government financial loan, business subsidy, micro-credit, or financial product, extract details.
If this is NOT a government financial/loan scheme, return {"is_scheme": false}.

Return ONLY valid JSON, nothing else:
{
  "is_scheme": true,
  "name": "Official loan/scheme name",
  "category": "loans",
  "what_you_get": "Simple description of the loan/subsidy",
  "benefit_amount": "Exact loan amount like ₹10L or Up to ₹50 Lakhs",
  "eligibility": {
    "age_min": null,
    "age_max": null,
    "income_max": null,
  ...
  "confidence_score": "float between 0.0 and 1.0 representing confidence this is a government loan"
}
`;
    ...
    for (const item of mySchemeItems) {
      try {
        ...
        const schemeData = {
          ...
          image_keyword: `${item.keyword} loan india`,
